...
image_path = "image/captured_image_20241204_112935.png"
...
if instances.has("pred_boxes") and instances.has("pred_classes"):
    ...
    for box, cls in zip(boxes, classes):
        ...
        cv2.putText(image, label, (int(x1), int(y1) - 10),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.6, color, 2)  # Use smaller font size and thinner thickness
...
cv2.putText(image, f"Kapsul: {kapsul_count}  Kemasan: {kemasan_count}", (10, 450),
            cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 255), 2, cv2.LINE_AA)  # Use smaller font size for count
